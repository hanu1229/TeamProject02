...
(0, '인천 부평구 부평문화로 37', 37.4927689553243, 126.719082567274, 2, 2, 76.74, '1986.09', '철근콘크리트', '홍길동', '올수리', 0, 5),
(0, '인천 부평구 부영로 35 e편한세상부평역센트럴파크', 37.4882700971426, 126.717135135567, 103, 5, 84.57, '2024.12', '철근콘크리트', '홍길동', '시스템에어컨2대', 0, 5),
(0, '인천 부평구 부영로 196', 37.5026526507224, 126.718118402099, 10, 2, 50.15, '1989.12', '철근콘크리트', '홍길동', '부평시장역 도보 10분', 1, 5),
(0, '인천 부평구 부영로 165 우성아파트', 37.5002788259456, 126.713048807847, 101, 2, 54.52, '1989.08', '철근콘크리트', '홍길동', '샷시 최근 교체', 0, 5),
(0, '인천 부평구 부흥로243번길 7', 37.4998000055664, 126.717938344817, 102, 12, 59.35, '1989.08', '철근콘크리트', '홍길동', '아주 깨끗하고 조용하고 밝은 집', 0, 5),
...
(2, '인천 부평구 경원대로1344번길 34 e편한세상시티부평역', 37.4902833072023, 126.719138689116, 103, 16, 23.13, '2023.08', '철근콘크리트', '홍길동', '역세권 도보 3분거리', 1, 5),
...
(0, '인천시 서구 청라동 173-1', 37.52753293, 126.6387486, 901, 15, 84.92, '2012.07', '철근콘크리트', '서진석', '방마다 시스템 에어컨', '2025-02-10 14:21:03', 1, 1),
...
(0, '인천시 서구 청라동 139-1', 37.53751155, 126.6384801, 376, 7, 100.51, '2012.03', '철근콘크리트', '서진석', '올수리 및 7호선 인접', '2025-02-10 21:07:55', 1, 1),
...
(0, '인천시 서구 심곡동 336-1', 37.54294031, 126.6706986, 104, 12, 59.88, '1997.01', '철근콘크리트', '서진석', '올수리 경기장뷰', '2025-02-10 00:11:36', 1, 1),
...
insert into brokerage(bfile, bmanager, bcomment, mno, pno) values ('brokerage_파일5.pdf', '김철수', '곰팡이 심함', 1, 4);
insert into brokerage(bfile, bmanager, bcomment, mno, pno) values ('brokerage_파일6.pdf', '김철수', '곰팡이 심함', 1, 4);
